...
public class HeatmapRenderer {
    ...
    public boolean render(int originX,
        ...
        if (displayOption == MainWindow.MatrixType.PEARSON) {
            ...
            BasicMatrix bm = zd.getPearsons(hic.getNormalizationType());
            if (bm == null) {
                bm = zd.computePearsons(hic.getDataset().getExpectedValues(zd.getZoom(),
                        hic.getNormalizationType()), hic.getNormalizationType());
            }
