...
public class AlignmentPair {
    ...
    public AlignmentPair(boolean strand1, int chr1, int pos1, int frag1, boolean strand2, int chr2, int pos2, int frag2, float score) {
        this(strand1, chr1, pos1, frag1, strand2, chr2, pos2, frag2);
        this.score = score;
    }
