...
public class HiCTools {
    ...
    public static void usage() {
        ...
        System.out.println("       hictools dump <observed/oe/pearson/norm/expected/eigenvector> <NONE/VC/VC_SQRT/KR/GW_VC/GW_KR/INTER_VC/INTER_KR> <hicFile(s)> <chr1> <chr2> <BP/FRAG> <binsize> [binary outfile]");
        System.out.println("       hictools addNorm <hicFile> [max genome-wide resolution, 0 for no frag]");
        System.out.println("       hictools bigWig <bigWig path or URL> <window size in bp> [chr] [start base] [end base]");
    ...
    public static void main(String[] argv) throws IOException, CmdLineParser.UnknownOptionException, CmdLineParser.IllegalOptionValueException {
        ...
        if (args[0].equalsIgnoreCase("bigWig")) {
            ...
            if (args.length == 3) {
                ...
                String chr = args[3];
                if (args.length == 4) {
                    BigWigUtils.computeBins(path, chr, windowSize);
                } else {
            ...
            AlignmentsSorter.sort(args[1], args[2], tmpDir);
            ...
            if (args.length < 2 || args.length > 3) {
                System.err.println("Usage: hictools addNorm hicFile <max genome-wide resolution>");
                System.exit(1);
            }
            String file = args[1];
            if (args.length > 2) {
            ...
            //hictools dump <observed/oe/pearson/norm/expected/eigenvector> <NONE/VC/VC_SQRT/KR> <hicFile> <chr1> <chr2> <BP/FRAG> <binsize> [outfile]")
